...
<head>
<meta charset="UTF-8">
<title>Ajouter un profeseur</title>
...
<body>
	...
	<div class="container mt-5 col-md-10 bg-light rounded-2">
		...
		<form action="/ProjetUniversity/TeacherInformation" method="post" onsubmit="return Ajouter()">
			...
			<div class="form-group m-2">
				<label for="cne">ID Professeur:</label> <input type="text"
					class="form-control" id="id_teacher" name="id_teacher" required>
			</div>
